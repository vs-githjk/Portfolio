...
/* React Bits <Radar />, adapted for this site: styles live in sections.css
   (.radar-container), and the pointer listener sits on window so the canvas
   can stay pointer-events: none inside a decorative layer. */

/* Hot-swapping a live WebGL component leaks contexts in dev — full reload. */
if (import.meta.hot) {
...
export default function Radar({
  ...
  useEffect(() => {
    ...
    /* window-level so the decorative layer can keep pointer-events: none */
    ...
    return () => {
      ...
      if (enableMouseInteraction) window.removeEventListener('pointermove', handleMouseMove);
