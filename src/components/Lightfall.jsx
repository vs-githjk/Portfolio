...
/* React Bits <Lightfall />, adapted for this site: styles live in sections.css
   (.lightfall-container), and the pointer listener sits on window so the
   canvas can stay pointer-events: none inside a decorative layer. */
