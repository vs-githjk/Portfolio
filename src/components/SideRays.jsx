/* SideRays — adapted from React Bits. Corner light-ray backdrop for the
   Value section (one instance per corner). Loaded lazily; styles live in
   sections.css. The component manages its own visibility observer and tears
   down its WebGL context when off-screen. */
